...
---
title: `r glue::glue("{params$checkDataset$runnerSummary$registry} DQ Report {params$checkDataset$runnerSummary$timestamp}")`
---
...
DT::datatable(summaryToPrint
  ...
  DT::formatStyle(
    names(summaryToPrint)[names(summaryToPrint) %in% c("cc2", "cc3")]
    ,backgroundColor = DT::styleInterval(1, c("#D1FFBD", "#FDFD96"))
  )
